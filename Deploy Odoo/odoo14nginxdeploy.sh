...
# Instalar y configurar nginx y crearle un certificado válido a Odoo mediante letsencript.
...
# 2.- Preconfigurar certbot y el serverblock de nginx para poder solicitar el certificado de letsencript
